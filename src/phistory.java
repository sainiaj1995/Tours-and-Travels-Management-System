...
public class phistory extends JFrame {
	...
	public phistory() {
		...
		String sql = "select ticket_packages.ptid ,ticket_packages.PACKAGE_NAME,PTRAVELLERS.userId,PTRAVELLERS.name,ticket_packages.pdoj from ticket_packages inner join  PTRAVELLERS  on ticket_packages.ptid = PTRAVELLERS.ptid  where ticket_packages.username_cust ='"+Home.loggedinuser+"'"+" order by ticket_packages.pdoj desc,ticket_packages.ptid";
		...
		try {
			...
			table = new JTable(buildTableModel(rs));
			 scrollPane = new JScrollPane(table);
				...
				JLabel lblNewLabel = new JLabel("PACKAGES HISTORY");
				...
				JCheckBox chckbxCancelIndividuals = new JCheckBox("CANCEL INDIVIDUALS PACKAGE");
