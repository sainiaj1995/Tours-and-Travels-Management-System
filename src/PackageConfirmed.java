...
public class PackageConfirmed extends JFrame {
	 ...
	 * Create the frame.
	 */
	public PackageConfirmed(String pid,String pname,String tfare,String notr,String doj,String name[],String age[],String userid[],String sex[]) {
		...
		textField_1 = new JTextField(pname);
		...
		textField_2 = new JTextField(tfare);
		...
		textField_3 = new JTextField(notr);
		...
		Object data[][] = new String[Integer.parseInt(notr)][4];
		for(int i=0;i<Integer.parseInt(notr);i++)
		{
			data[i][0] = name[i];
			data[i][1] = age[i];
			data[i][2] = sex[i];
	...
	table.setBorder(UIManager.getBorder("Table.scrollPaneBorder"));
		...
		JLabel lblYourPackageHas = new JLabel("YOUR PACKAGE HAS BEEN BOOKED");
